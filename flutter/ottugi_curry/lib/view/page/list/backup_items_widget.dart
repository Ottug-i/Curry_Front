...
class ItemsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: rListController.MenuModelList.length ?? 0,
                  ...
                  Expanded(
                    ...
                    child: ClipRRect(
                        ...
                        child:
                            ...
                            /*Image.network(
                        '${rListController.MenuModelList[i].thumbnail}',
                        ...
                        loadingBuilder: (BuildContext context, Widget child,
                          ...
                          return const Center(
                            ...
                            Image.asset(
                                'assets/images/${rListController.MenuModelList[i].thumbnail}')),
                  ),
                  Expanded(
                    flex: 7,
                    child: Padding(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Obx(() => Text(
                                        '${rListController.MenuModelList[i].name}',
                          ...
                          Row(children: [
                            Expanded(
                                child: Obx(
                              () => Text(
                                '${rListController.MenuModelList[i].ingredients}',
                                style: const TextStyle(
                                  fontFamily: 'Poppins',
                                  fontSize: 14,
                                  color: Colors.black,
                          ...
                          Row(
                            ...
                            children: [
                              iconWithText(Icons.timer,
                                  '${rListController.MenuModelList[i].time}분'),
                              iconWithText(Icons.handshake_outlined,
                                  '${rListController.MenuModelList[i].difficulty}'),
                              iconWithText(Icons.food_bank_rounded,
                                  '${rListController.MenuModelList[i].composition}'),
                            ],
                          )
                        ],
                      ),
