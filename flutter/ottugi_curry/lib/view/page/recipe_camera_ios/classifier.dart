...
class Classifier {
  ...
  static const String MODEL_FILE_NAME = "ml_model/detect.tflite";
  static const String LABEL_FILE_NAME = "ml_model/labelmap.txt";
  ...
  void loadModel({Interpreter? interpreter}) async {
    try {
      ...
      outputTensors?.forEach((tensor) {
        ...
        print('hi 2');
        // _outputTypes?.add(dataTypeOf(tensor));

        _outputTypes?.addAll(tensor.type as Iterable<TfLiteType>);
      });
    } catch (e) {
      print(e);
    }
